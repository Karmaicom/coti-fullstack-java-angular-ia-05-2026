...
export const routes: Routes = [
    {
        ...
        component: AutenticarUsuario  //component renderizado
    },
    {
        path: 'pages/criar-usuario',   //rota de navegação
        component: CriarUsuario        //component renderizado
    },
    {
        path: 'app/dashboard',  //rota de navegação
        component: Dashboard      //component renderizado
    },
    {
        path: '', pathMatch: 'full',  //rota raiz
        redirectTo: '/pages/autenticar'  //redirecionamento
    },
];
